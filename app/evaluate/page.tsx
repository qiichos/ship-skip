      ...
      <main className="mx-auto max-w-5xl px-6 pt-28 pb-20">
        ...
        {phase === "setup" && (
          <div className="mx-auto max-w-2xl">
            ...
            <div className="mb-8">
              ...
              <div className="flex gap-3">
                <Input
                  ...
                  className="h-12 border-zinc-800 bg-zinc-900/50 text-base text-zinc-100 placeholder:text-zinc-600"
                />
                <Button
                  variant="outline"
                  size="icon"
                  className="h-12 w-12 shrink-0 border-zinc-800"
                  disabled={!url.trim()}
                >
            ...
            <Button
              size="lg"
              className="h-14 w-full gap-2 rounded-xl bg-indigo-600 text-base font-medium text-white shadow-lg shadow-indigo-500/20 hover:bg-indigo-500"
            ...
            <div className="mx-auto mb-10 grid max-w-3xl gap-6 sm:grid-cols-2">
              <Card className="border-emerald-500/10 bg-emerald-950/5">
                <CardContent className="p-6">
                  ...
                  <div className="space-y-3">
                    {finalReport.positives.slice(0, 4).map((item, i) => {
              ...
              <Card className="border-red-500/10 bg-red-950/5">
                <CardContent className="p-6">
                  ...
                  <div className="space-y-3">
                    {finalReport.negatives.slice(0, 4).map((item, i) => {
                      const persona = PERSONAS.find((p) => p.id === item.persona);
                      return (
                        <div key={i} className="flex gap-2">
